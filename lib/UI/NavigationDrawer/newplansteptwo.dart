...
import 'newplanstepthree.dart';

class NewPlanStepTwo extends StatelessWidget {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  StepTextWidget("02 of 03 (Plan Duration)"),
                  SizedBox(
                    height: space_between_title_textField,
                  ),
                  Divider(
                  ...
                  TextFieldTitle("Select an option you’d like"),
                  SizedBox(
                    height: space_between_title_textField,
                  ),
                  ...
                  TextFieldTitle("Select Preferred Date"),
                  SizedBox(
                    height: space_between_title_textField,
                  ),
                  CustomTextFieldWithSuffixIcon("Please Select",Icons.calendar_today,Color(0xFF28CC84)),
                  SizedBox(
                    height: SizeConfig.screenwidth * 0.47,
                  ),
                  CustomButton("Next", (){
                    Navigator.push(context, CupertinoPageRoute(builder: (context)=>NewPlanStepThree()));
                  }),
                  SizedBox(
                    height: itemspace,
                  ),
